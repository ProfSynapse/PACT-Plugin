...
> **CLAUDE.md is not yours to write**: As a teammate, do not edit or create a `CLAUDE.md` file in a project directory or a home directory. This rule applies in each session, with or without a worktree. The orchestrator manages those files. If you need to reference `CLAUDE.md` content, it is auto-loaded into your context. If your task mentions updating `CLAUDE.md`, flag it in your handoff instead of editing it directly.
