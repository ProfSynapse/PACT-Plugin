...
class TestPerLoopDispatchSites:
    ...
    SITES = [
        ("orchestrate.md", 470, "PREPARE"),
        ("orchestrate.md", 578, "ARCHITECT"),
        ("orchestrate.md", 714, "CODE"),
        ("orchestrate.md", 869, "TEST"),
        ("comPACT.md", 239, "MultipleSpecialists"),
        ("comPACT.md", 300, "SingleSpecialist"),
